(function() {
    ...
    .directive('sort', ['$rootScope', '$ionicGesture', function($rootScope, $ionicGesture) {
        return {
            restrict: 'E',
            ...
            link: function($scope, $element, $attr, ctrl) {
                ...
                $scope.openSort = function() {
                    ctrl.open();
                    $scope.drawerClicked = true;
                };
                $scope.closeSort = function() {
                    ctrl.close();
                    $scope.drawerClicked = false;
                };
            }
        }
    }])

    .directive('filter', ['$rootScope', '$ionicGesture', function($rootScope, $ionicGesture) {
        return {
            restrict: 'E',
            controller: 'drawerCtrl',
            link: function($scope, $element, $attr, ctrl) {
