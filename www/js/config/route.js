var appStates = {
    ...
    tabmylearningmodal: { name: 'tab.mylearningmodal', url: '/mylearning/modal/:id', views: { 'tab-mylearning@tab': { templateUrl: "templates/mylearning/modal.html", controller: 'MyLearningCtrl' } } },
    ...
    tabtechtipsleafcontent: { name: 'tab.techtipsleafcontent', url: '/techtipsleafcontent', views: { 'tab-techtips@tab': { templateUrl: "templates/techtips/techtipsleafcontent.html", controller: 'TechtipsCtrlTitle' } } },
    ...
    tabscteSTD: { name: 'tab.resource.scteSTD', url: '/SCTE-STANDARDS', views: { 'tab-resource@tab': { templateUrl: "templates/resource/SCTEstd.html", controller: 'ResourceCtrl' } } },
    tabwhitepaper: { name: 'tab.whitepaper', url: '/whitepaper', views: { 'tab-resource@tab': { templateUrl: "templates/resource/whitepaper.html", controller: 'ResourceCtrl' } } },

    tabeventsdetails: { name: 'tab.eventsdetails', url: '/events/eventsdetails/:id', views: { 'tab-discover@tab': { templateUrl: "templates/discover/events-details.html", controller: 'DiscoverEventsCtrl' } } },
