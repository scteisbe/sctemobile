var appStates = {
	...
	tabdiscoversmyevents : {name:'tab.discoversmyevents', url:'/myevents', views:{'tab-discover@tab':{templateUrl:"templates/resource/myevents.html", controller: 'ResourceCtrl'}}},
	...
	tabscteSTD : {name:'tab.scteSTD', url:'/SCTE-STANDARDS', views:{'tab-resource@tab':{templateUrl:"templates/resource/SCTEstd.html", controller: 'ResourceCtrl'}}},	tabscteSTD : {name:'tab.resource.scteSTD', url:'/SCTE-STANDARDS', views:{'tab-resource@tab':{templateUrl:"templates/resource/SCTEstd.html", controller: 'ResourceCtrl'}}},
